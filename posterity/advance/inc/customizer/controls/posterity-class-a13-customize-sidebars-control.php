...
class Posterity_A13_Customize_Sidebars_Control extends WP_Customize_Control {
	 ...
	 *
	 * @see Posterity_A13_Customize_Socials_Control::content_template()
	 */
		...
		<div class="customize-control-content">
			...
			#>
				<div class="custom_sidebar-row clearfix">
					<label class="screen-reader-tex" for="{{ id_prefix }}sidebar-{{ index }}"><?php esc_html_e( 'Name of sidebar', 'posterity' ); ?> {{ index }}</label>
