...
class Posterity_A13_Customize_Spacing_Control extends WP_Customize_Control {
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		$this->side_labels = array(
			'top' => esc_html__( 'Top', 'posterity' ),
			'right' => esc_html__( 'Right', 'posterity' ),
			'bottom' => esc_html__( 'Bottom', 'posterity' ),
	 ...
	 *
	 * @see Posterity_A13_Customize_Spacing_Control::content_template()
	 */
	...
	public function content_template() {
		...
		<div class="customize-control-content">
			...
			<label class="screen-reader-text" for="{{ id_prefix }}{{ mode }}-unit"><?php esc_html_e( 'Unit', 'posterity' ); ?></label>
